                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (dataSnapshot.exists()) {
                        ...
                        if (dataSnapshot.hasChild("Security Questions ")) {
                            String answer1 = dataSnapshot.child("Security Questions").child("answer1").getText().toString();
                            String answer2 = dataSnapshot.child("Security Questions").child("answer2").getText().toString();
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        if (!newPassword.getText().toString().equals("")) {
                                            ref.child("password")
                                                    ...
                                                    .addOnCompleteListner(new OnCompleteListener<Void>() {
